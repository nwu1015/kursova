...
@WebServlet(name = "AdminElementController", value = {"/admin-page.jsp"})
public class AdminElementController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("admins/testpage.jspf").forward(req, resp);
    }
